...
var
  AComboBox: TcxComboBox;
  ScriptFileName, DBVersionStr: string;
  I: Integer;
begin
  inherited;
//  lucScriptFile.SetFocus;
...
//  DBVersionStr := '';
//
//  for I := Length(ScriptFileName) downto 1 do
//  begin
//    if ScriptFileName[I] = ' ' then
//      Break;
//    DBVersionStr := ScriptFileName[I] + DBVersionStr;
//  end;
//
//  FSelectedDBVersion := StrToInt(DBVersionStr);
  LoadScriptFile(StrToint(ScriptFileName));
//  LoadScriptFile(FSelectedDBVersion);
end;
